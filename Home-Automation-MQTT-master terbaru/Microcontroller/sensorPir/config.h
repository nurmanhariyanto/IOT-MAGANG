...
char wifi_ssid[34] = "RuangIOT";
char wifi_password[34] = "lskkiot2019";
char mqtt_server[40] = "rmqbluelight.pptik.id";
int mqtt_port = 1883;
char smqtt_port[5] = "1883";
char mqtt_user[40] = "/bluelight:bluelight";
char mqtt_password[40] = "bluelight123!";
char mqtt_keywords1[40] = "bluelightin"; //gas
//char mqtt_keywords2[40] = "node03-api"; //api
