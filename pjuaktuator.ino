...
const char* CL = "LSKK-HA-AKTUATOR-10";
...
//708de1f7-90c2-4114-93bb-303cd2713dc0 
//E8:DB:84:98:B6:8D
...
const char* device_guid = 5b0ed6a6-8e02-11eb-8dcd-0242ac130003";
String output_value;
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  String pubmsg = String(device_guid) + "#" + String(statusDevice);
